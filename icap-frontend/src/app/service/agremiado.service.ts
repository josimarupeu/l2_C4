...
export class AgremiadoService extends GenericService<Agremiado> {
  private agremiadosSubject: Subject<AgremiadoReport[]> = new Subject<AgremiadoReport[]>;
  ...
  setAgremiadosSubject(data: AgremiadoReport[]){this.agremiadosSubject.next(data);}
  getAgremiadosSubject(){return this.agremiadosSubject.asObservable();}
