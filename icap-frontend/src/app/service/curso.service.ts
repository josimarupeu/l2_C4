...
export class CursoService extends GenericService<Curso> {
  ...
  private cursoSeleccionadoSubject = new BehaviorSubject<CursoReport | null>(null);
  ...
  setCursosSubject(data: CursoReport[]){this.cursosSubject.next(data);}
  getCursosSubject(){return this.cursosSubject.asObservable();}
